...
typedef struct
{
    ...
    uint8_t         Payload_Length;		// Specifies the number of data bits transmitted or received in a frame
    									// This parameters must be set based on @ref UART_ Payload_Length_define
...
#define UART_StopBits_1_half			(unit32_t)(3<<12)
...
#define UART_IRQ_Enable_TC			(uint32_t)(1<<6)	 // Transmission complete interrupt enable // Transmission complete
